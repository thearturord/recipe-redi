...
let api = "https://cors-anywhere.herokuapp.com/http://www.recipepuppy.com/api/?";
let i = "i=";
let q = "q=";
let p = "p=";

// let econdedField = encodeURIComponent(ingredients);
...
async function getRecipes(ingredients) {
    let response = await fetch(api + i + ingredients);
